sap.ui.define([
	...
	const initialValues = {
		...
		return BaseController.extend("incidentspa49930u00ui.controller.Create", {
            onInit: function () {
		...
		var data = this.getView()
            ...
            if (data.title != "" && data.description != "") {
				...
				var settings = {
					async: true,
					url: "/odata/v4/incident/SafetyIncidents",
					method: "POST",
					headers: {
        ...
        createPicture: function (response) {
			...
			var settings = {
				async: true,
				crossDomain: true,
				url: "/odata/v4/incident/IncidentPhotos",
				"method": "POST",
				"timeout": 0,
				"headers": {
					"content-type": "application/json"
        ...
        uploadPicture: function (response) {
			...
			xhr.open("PUT", "/odata/v4/incident/IncidentPhotos(" + id + ")/image");
